...
public class DatabaseInit implements ApplicationRunner{
    ...
    public void run(ApplicationArguments args) throws Exception{
        ...
        adminRepository.save(Admin.builder().usuario("admin").contrasena("admin").build());
        ...
        veterinarioRepository.save(Veterinario.builder().cedula(1234L).contrasena("vet").foto("https://img.freepik.com/vector-gratis/grupo-personas-sonrientes-felices-mirando-vista-superior-ilustracion-vector-plano-fondo-blanco_1284-78599.jpg").nombre("Monica").estado(true).especialidad(especialidadRepository.findById(1L).get()).build());
