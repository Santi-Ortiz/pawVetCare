...
public class TratamientoServiceTestNaive {
    ...
    public void TratamientoService_agregarTratamiento_Tratamiento() {
        Especialidad especialidad = new Especialidad("cirugia");
        especialidadRepository.save(especialidad); 
        Veterinario veterinario = new Veterinario(789456L, "2345", "foto", "Erick Prydz", true, especialidad);
    ...
    public void TratamientoService_findById_Tratamiento() {
        ...
        Veterinario veterinario = new Veterinario(123456L, "2345", "foto", "Pablo Perez", true,
                new Especialidad("Traumatologia"));
    ...
    public void TratamientoService_obtenerTotalTratamientosMesActual() {
        ...
        Tratamiento tratamiento1 = new Tratamiento(java.sql.Date.valueOf("2024-10-01"), new Veterinario(),
                new Mascota());
        Tratamiento tratamiento2 = new Tratamiento(java.sql.Date.valueOf("2024-10-15"), new Veterinario(),
                new Mascota());
        Tratamiento tratamiento3 = new Tratamiento(java.sql.Date.valueOf("2024-10-18"), new Veterinario(),
                new Mascota());
        Tratamiento tratamiento4 = new Tratamiento(java.sql.Date.valueOf("2024-10-20"), new Veterinario(),
                new Mascota());
